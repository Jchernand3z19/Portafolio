...
AUTHORIZED_LIVE_AUTH = "LC-location-binding-332"
CONSUMED_AUTHS = frozenset({"LC-location-binding-336", "LC-location-binding-331"})
...
def test_live_has_only_lc_332_active_and_keeps_prior_authorizations_consumed() -> None:
