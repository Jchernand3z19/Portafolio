...
SCRAPE_RUNS = BigQueryTableSpec(
    ...
    fields=(
        ...
        F("authority_evidence_id", "STRING"),
        F("authority_attestation_json", "STRING"),
        F("authority_signing_key_id", "STRING"),
        F("authority_public_key_spki_sha256", "STRING"),
        F("authority_decided_at_utc", "TIMESTAMP"),
        F("supermarket_id", "STRING", True),
        F("location_id", "STRING", True),
