...
Esta evidencia corresponde al primer recorrido completo aceptado del catálogo público de Comisariato Los Andes para San Pedro Sula.
...
`evidence.json` es el manifiesto compacto versionado. El artefacto de GitHub Actions contiene el RAW, ledger y snapshot completo utilizado para producir estos hashes.
